...
describe('orderUtils', () => {
  const mockOrder: InFlightOrder = {
    ...
    isPendingCancelConfirmation: false,
    isOpen: true,
    isFilled: false,
    isFailure: false,
    isCancelled: false,
    exchangeOrderIdPromise: Promise.resolve('exchange-id-123'),
    completelyFilledPromise: new Promise(() => {}),
    processedByExchangePromise: Promise.resolve(),
    updateState: jest.fn(),
